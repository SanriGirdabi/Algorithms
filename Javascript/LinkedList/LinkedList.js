...
class LinkedList {
  ...
  addBefore(beforeData, data) {
    ...
    throw new Error(`Node with data ${beforeData} not found in the List!`);
  }
  ...
  removeData(data) {
    ...
    throw new Error(`Node with data ${data} not found in the List!`);
  }
...
console.log(letters.get_length()); // 7
